...
RcppExport SEXP _inf_ranger_randomObsNode(SEXP groupsSEXP, SEXP ySEXP, SEXP inbag_countsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _inf_ranger_hshrink_regr(SEXP left_childrenSEXP, SEXP right_childrenSEXP, SEXP num_samples_nodesSEXP, SEXP node_predictionsSEXP, SEXP split_valuesSEXP, SEXP lambdaSEXP, SEXP nodeIDSEXP, SEXP parent_nSEXP, SEXP parent_predSEXP, SEXP cum_sumSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _inf_ranger_hshrink_prob(SEXP left_childrenSEXP, SEXP right_childrenSEXP, SEXP num_samples_nodesSEXP, SEXP class_freqSEXP, SEXP lambdaSEXP, SEXP nodeIDSEXP, SEXP parent_nSEXP, SEXP parent_predSEXP, SEXP cum_sumSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::IntegerVector& >::type left_children(left_childrenSEXP);
    Rcpp::traits::input_parameter< Rcpp::IntegerVector& >::type right_children(right_childrenSEXP);
...
RcppExport SEXP _inf_ranger_replace_class_counts(SEXP class_counts_oldSEXP, SEXP class_counts_newSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_inf_ranger_rangerCpp", (DL_FUNC) &_inf_ranger_rangerCpp, 55},
    {"_inf_ranger_numSmaller", (DL_FUNC) &_inf_ranger_numSmaller, 2},
    {"_inf_ranger_randomObsNode", (DL_FUNC) &_inf_ranger_randomObsNode, 3},
    {"_inf_ranger_hshrink_regr", (DL_FUNC) &_inf_ranger_hshrink_regr, 10},
    {"_inf_ranger_hshrink_prob", (DL_FUNC) &_inf_ranger_hshrink_prob, 9},
    {"_inf_ranger_replace_class_counts", (DL_FUNC) &_inf_ranger_replace_class_counts, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_inf_ranger(DllInfo *dll) {
